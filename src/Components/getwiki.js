...
import { Research } from "../Components/RecentSearches/recent-searches";
...
export const GetWiki = () => {
  ...
  const [recentSearches, setRecentSearches] = useState(JSON.parse(localStorage.getItem('recents')) || []);
  ...
  return (
    <>
      ...
      <div className="parentDiv">
       ...
       <Research setData={setData} setSearch={setSearch} setSearchInfo={setSearchInfo}/>
